<svg width="128" height="128" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {{ $attributes }}>
    <path fill="#62727a" d="M63 60H1c-.6 0-1 .5-1 1v2c0 .5.4 1 1 1h62c.5 0 1-.5 1-1v-2c0-.5-.5-1-1-1" />
    <path fill="#ed4c5c" d="M40 64H24l4-4h8z" />
    ...
    <path fill="#62727a" d="M19 44h26v6H19zm2.1-6.4v1.9H23v-1.9h1.1v4.8H23v-2h-1.8v2H20v-4.8zm9.2 2.4c0 1.6-1 2.5-2.4 2.5c-1.5 0-2.3-1.1-2.3-2.5c0-1.5.9-2.5 2.4-2.5s2.3 1.1 2.3 2.5m-3.6 0c0 .9.5 1.6 1.2 1.6c.8 0 1.2-.7 1.2-1.6c0-.9-.4-1.6-1.2-1.6c-.7 0-1.2.7-1.2 1.6m5.8-1.5h-1.3v-.9H35v.9h-1.3v3.9h-1.1v-3.9zm6.7 1.9h-1.8v1.1h2v.9h-3.1v-4.8h3v.9h-1.9v1h1.8zm1.7-2.8H42v3.9h2v.9h-3.1z" />
    ...
    <path fill="#ed4c5c" d="M33 1.4v5.1c2.7 1.5 3.3-1.5 6 0V1.4c-2.7-1.5-3.3 1.6-6 0" />
