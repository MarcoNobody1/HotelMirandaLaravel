    ...
    form.addEventListener("submit", function (e) {
        if (firstnameinput) {
            ...
            if (firstnameinput.value.trim() === "") {
                ...
                notification(
                    "Error: Email not valid. Check your answer again.",
                    "error"
                );
            } else if (phoneinput.value.trim() === "") {
                notification(
                    "Error: Phone not valid. Check your answer again.",
                    "error"
                );
          ...
          e.preventDefault();
          notification("Error: Check in cannot be greater than Check out", "error", true);
        }
